...
export default function Home() {
    ...
    const portfolioItems = [
        ...
        },
        {
            ...
            image: '/portfolio/consulting.png'
        }
    ]
                                    ...
                                    {portfolioItems.map((item, index) => (
                                        <Card key={index} className="overflow-hidden border-none shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                                            <div className="relative h-48 w-full overflow-hidden">
                                                ...
                                                {/* Overlay gelap tipis biar teks jelas */}
                        ...
                        <div className="hidden md:flex items-center space-x-1">
                            {navigation.map((item) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${currentPage === item.page
                        ...
                        <div className="px-4 py-4 space-y-2">
                            {navigation.map((item) => (
                                <button
                                    ...
                                    className={`block w-full text-left px-4 py-3 rounded-lg font-medium transition-all ${currentPage === item.page
                                            ? 'bg-blue-100 text-blue-900'
                                            : 'text-gray-600 hover:text-blue-900 hover:bg-gray-50'
                                        }`}
                                >
